...
export default function Owners({contractName, signaturesRequired, address, nonce, mainnetProvider, localProvider, yourLocalBalance, price, tx, readContracts, writeContracts, blockExplorer }) {
  ...
  return (
    <div>
      ...
      <List
        ...
        renderItem={item => {
          return (
            <List.Item key={"owner_"+item.args[0]+"_blockN_"+item.blockNumber}>
            <Address
              address={item.args[0]}
